...
CUDA_LAUNCH_BLOCKING=1 python -W ignore train.py --dataset cifar10 --data_path ./dataset/     --model resnet18_quant_tanh     --save_path "./save/resnet18_quant_tanh/resnet18_quant_tanh_w2_a2_mode_mean_k2_lambda_wd0.0005_swpFalse_g02/"     --epochs ${epochs}     --log_file  "resnet18_quant_tanh_w2_a2_mode_mean_k2_lambda_wd0.0005_swpFalse_g02.log"    --lr  ${lr}     --schedule 60 120     --gammas 0.1 0.1     --batch_size ${batch_size}     --ngpu 1     --wd ${wd}     --k ${k}     --group_ch ${group_ch}     --wbit ${wbit}     --abit ${abit} --resume "/content/IMC-SRAM-Modeling/CIFAR-10_ResNet18_2-bit/save/resnet18_quant_tanh/resnet18_quant_tanh_w2_a2_mode_mean_k2_lambda_wd0.0005_swpFalse_g02/resnet18-5c106cde.pth" --fine_tune --quant_bound 1.0 --number_levels 2 --offset_noise 2.5 --bitline_noise 6 --sram_depth 256
...
#--resume "/content/IMC-SRAM-Modeling/CIFAR-10_ResNet18_2-bit/save/resnet18_quant_tanh/resnet18_quant_tanh_w2_a2_mode_mean_k2_lambda_wd0.0005_swpFalse_g02/resnet18-5c106cde.pth" --fine_tune
...
parser.add_argument('--adc_levels', '--adc_levels', default=16, type=int, help='ADC levels')
...
def test(epoch):
    ...
    if acc > best_acc and args.save:
        torch.save(state, os.path.join('/content/drive/MyDrive/checkpoint', args.save))
        best_acc = acc
    if args.save:
        torch.save(state, os.path.join('/content/drive/MyDrive/checkpoint', 'Resnet18_model_a4_w4_tiny_imagenet'+'_test_acc_'+str(test_acc)+'_.pth'))
...
update_sram_depth(model, args.sram_depth, args.quant_bound, args.prob_table, args.prob_table_9, args.noise_std, args.noise_9_std, args.noise_9_mean, args.adc_levels)
print("SRAM DEPTH: ",args.sram_depth,"ADC Levels: ",args.adc_levels,"QB: ",args.quant_bound,"SD: ",args.noise_9_std,"MEAN: ",args.noise_9_mean)
...
for epoch in range(start_epoch, args.epochs):
    ...
    print('Layer Weight: %.3f'%model.layer[0].weight)